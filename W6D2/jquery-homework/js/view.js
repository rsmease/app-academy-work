...
View.prototype.exercise4 = function () {
  ...
  //   }
  // });
  $(".square:nth-child(even)").text(name).addClass('padded');
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  // $(".squaure").on("click", "li", function() {
  //   alert(this.data-pos);
  // })
 //forgot to set currentTarget
  $('.square').on("click", e => {
...
View.prototype.exercise6 = function () {
  ...
  //your code here!
  // $("li").css("background", _randomColorString());
  // $("li").attr("background-color", window._randomColorString());
  $(".square").each(function(index, ele) {
    const curr = $(ele);
    curr.css("background", window._randomColorString());
  });
};
...
View.prototype.exercise7 = function(){
  ...
  $(".square").on("mouseover", function(event) {
    ...
    console.log(current['style']['background-color']);
  });
};
